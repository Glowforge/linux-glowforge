...
{
	u32 ctrl = MX51_ECSPI_CTRL_ENABLE, cfg = 0, dma = 0, period = 0;
	u32 tx_wml_cfg, rx_wml_cfg, rxt_wml_cfg;
	u32 clk = config->speed_hz, num_wait_states, delay;
	...
	num_wait_states = (config->delay_usecs * config->speed_hz) / 1000000;
				 ...
				 struct spi_transfer *t)
{
	...
	config.delay_usecs = t ? t->delay_usecs : 0;
